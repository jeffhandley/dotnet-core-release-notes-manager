...
- [.NET Runtime](https://github.com/dotnet/core/blob/main/release-notes/11.0/preview/preview6/runtime.md) — ARM64 PAC-RET JIT security, in-process crash reporting, SIMD lane APIs, Stream wrappers for memory types, and X25519 key agreement on Android
- [.NET Libraries](https://github.com/dotnet/core/blob/main/release-notes/11.0/preview/preview6/libraries.md#systemtextjson-union-support) — System.Text.Json union support, configurable EnvironmentVariables name transformation, DI singleton disposal fix, CBOR nesting depth limit
