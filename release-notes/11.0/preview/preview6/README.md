...
These notes cover the highest-value changes that shipped in .NET 11 Preview 6:
...
| | Version |
| --- | --- |
| Runtime | 11.0.0-preview.6.26327.103 |
| SDK | 11.0.100-preview.6.26327.103 |

### VMR refs

These release notes were generated from the [dotnet/dotnet](https://github.com/dotnet/dotnet) VMR:

- **Base**: [`v11.0.0-preview.5.26302.115`](https://github.com/dotnet/dotnet/tree/v11.0.0-preview.5.26302.115)
- **Head**: [`release/11.0.1xx-preview6`](https://github.com/dotnet/dotnet/tree/release/11.0.1xx-preview6)
...
.NET 11 Preview 6 are available from
